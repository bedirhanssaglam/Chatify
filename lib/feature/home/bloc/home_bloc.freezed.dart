...
mixin _$HomeState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(List<Account> users) loaded,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(List<Account> users)? loaded,
...
class _$LoadedImpl implements _Loaded {
  const _$LoadedImpl(final List<Account> users) : _users = users;
...
abstract class _Loaded implements HomeState {
  const factory _Loaded(final List<Account> users) = _$LoadedImpl;
